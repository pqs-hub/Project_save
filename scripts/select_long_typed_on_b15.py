#!/usr/bin/env python3
"""Select one long-real typed checkpoint and trust decay using b15 only."""
...
BASE = ROOT / "autoresearch/loop-260720-0945/model_training_round3"
...
def main() -> None:
    ...
    for path in sorted(SELECT.glob("*/decay_*/results.tsv")):
    ...
    manifest = {
        ...
        "rule": "maximize standardized b15 delta TC; inspect no other final circuit",
        "winner": candidates[0],
