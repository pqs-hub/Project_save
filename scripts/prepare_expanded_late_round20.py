#!/usr/bin/env python3
"""Prepare a leak-free, type-balanced late-prefix ATPG source set."""
...
# Emphasize difficult low-TC sources so late states retain enough unresolved
# faults, while keeping the two largest Round9 sources for structural scale.
BENCHMARKS = [
    "subckt_0240",
    "subckt_0279",
    "subckt_0173",
...
def main() -> None:
    ...
    manifest = {
        "round": 20,
        "purpose": "expanded late-horizon real ATPG supervision for within-type list ranking",
