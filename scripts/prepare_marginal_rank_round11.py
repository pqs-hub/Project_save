#!/usr/bin/env python3
"""Prepare Round11 isolated horizon-aware marginal-ranking adapter configs."""
...
ROOT = LOOP / "model_training_round11"
...
VARIANTS = {
    "marginal_horizon_lr2e5": {"lr": 2.0e-5},
    "marginal_horizon_lr5e5": {"lr": 5.0e-5},
    "marginal_horizon_lr1e4": {"lr": 1.0e-4},
}
...
def main() -> None:
    ...
    print(
        "validated marginal-rank oracle "
        ...
        config.update(
            {
                ...
                "trainable_modules": "typed_marginal_rank_only",
                "seed": 2129,
                "epochs": 8,
                "oracle_actions": [
                ...
                # Only the new scalar marginal adapter receives gradients.
    ...
    provenance = {
        "round": 11,
        "purpose": "isolated horizon-aware marginal-TC candidate ranking",
