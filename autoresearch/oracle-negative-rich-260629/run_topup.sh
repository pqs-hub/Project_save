...
SUBCKTS="autoresearch/oracle-negative-rich-260629/sample/topup_subckts.txt"
...
python scripts/audit_oracle_action_groups.py \
  --oracle-tsv topup=autoresearch/oracle-negative-rich-260629/topup/oracle_actions.tsv \
  --out-dir autoresearch/oracle-negative-rich-260629/topup_audit
